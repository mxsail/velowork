# Velowork Windows Installer
# Usage: irm https://raw.githubusercontent.com/mxsail/velowork/main/install.ps1 | iex
...
$InstallDir = "$env:LOCALAPPDATA\Programs\Velowork"
$BinName = "velowork.exe"
...
Write-Host "Installing Velowork v$Version..."

# Download
$Artifact = "velowork-windows-x64"
$DownloadUrl = "https://github.com/$Repo/releases/download/v$Version/$Artifact.zip"
$TempDir = New-TemporaryFile | ForEach-Object { Remove-Item $_; New-Item -ItemType Directory -Path $_ }
$ZipPath = Join-Path $TempDir "velowork.zip"
...
$ShortcutPath = Join-Path $StartMenuDir "Velowork.lnk"
...
Write-Host ""
Write-Host "Velowork installed successfully!" -ForegroundColor Green
Write-Host ""
Write-Host "  Location: $InstallDir\$BinName"
Write-Host "  Shortcut: $ShortcutPath"
Write-Host ""
Write-Host "Launch from Start Menu or run: velowork"
Write-Host ""
