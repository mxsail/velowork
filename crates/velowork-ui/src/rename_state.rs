...
//!
//! Provides a generic helper for inline rename functionality with InputState.
...
///
/// Creates a new `RenameState` with a configured `InputState`.
...
pub fn rename_input<Id>(state: &Option<RenameState<Id>>) -> Option<&Entity<InputState>> {
