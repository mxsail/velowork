...
//!
//! Lives in `velowork-core` so both the producers (`velowork-files`, `velowork-views-git`)
//! and the broker queue type (`velowork-workspace`) can refer to it without forming
//! a dependency cycle.
